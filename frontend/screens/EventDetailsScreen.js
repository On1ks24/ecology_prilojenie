...
const EventDetailsScreen = ({ route, navigation }) => {
  ...
  const loadEventDetails = async () => {
    try {
      ...
      setIsOrganizer(details.event.organizer_id === userId);
    ...
    <>
      ...
      <View style={styles.eventContainer}>
        ...
        <ImageBackground
          ...
          style={styles.eventHeaderBackground}
          resizeMode="cover"
        >
          {/* Кнопка назад */}
          <TouchableOpacity 
          ...
          >
            <Text style={styles.eventBackButtonText}>← Назад</Text>
          </TouchableOpacity>

          {/* Информация о субботнике по центру с белым фоном */}
          <View style={styles.eventInfoCard}>
            <Text style={styles.eventName}>{eventData?.name}</Text>
            <View style={styles.eventIdContainer}>
              <Text style={styles.eventIdLabel}>ID:</Text>
              <Text style={styles.eventIdValue}>{eventData?.id}</Text>
            </View>
            ...
            {eventData?.isFinished && (
              <View style={styles.eventFinishedBadge}>
                <Text style={styles.eventFinishedText}>Мероприятие завершено</Text>
              </View>
            )}
          </View>
        </ImageBackground>
        ...
        <View style={styles.eventTabContainer}>
          <TouchableOpacity
            ...
            style={[styles.eventTab, activeTab === 'info' && styles.eventTabActive]}
          >
            <Text style={[styles.eventTabText, activeTab === 'info' && styles.eventTabTextActive]}>
              Информация
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => setActiveTab('rating')}
            style={[styles.eventTab, activeTab === 'rating' && styles.eventTabActive]}
          >
            <Text style={[styles.eventTabText, activeTab === 'rating' && styles.eventTabTextActive]}>
              Рейтинг
            </Text>
          </TouchableOpacity>
        </View>
